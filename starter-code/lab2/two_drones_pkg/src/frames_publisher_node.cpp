...
class FramesPublisherNode : public rclcpp::Node {
 ...
 public:
  ...
  void onPublish() {
    ...
    double time = (current_time - startup_time).seconds();
    ...
    // World_T_av1
    world_T_av1.header.stamp = current_time;
    ...
    world_T_av2.header.stamp = current_time;
    ...
    world_T_av2.transform.translation.z = std::cos(2.0 * time);

    tf2::Quaternion q_av2;
    q_av2.setRPY(0.0, 0.0, 0.0);
    q_av2.normalize();
